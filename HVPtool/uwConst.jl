...
#     "A653" => Dict("mPi" => uwreal([0.21193,0.00091], "mPi"), "mK" => uwreal([0.21193,0.00091], "mK"), "mRhoOld" => uwreal([0.4240,0.0088], "mRhoOld")), 
#     "A654" => Dict("mPi" => uwreal([0.16647,0.00121], "mPi"), "mK" => uwreal([0.22712,0.00089], "mK"), "mRhoOld" => uwreal([0.3988,0.0019], "mRhoOld")),         
#     "H101" => Dict("mPi" => uwreal([0.18217,0.00062], "mPi"), "mK" => uwreal([0.18217,0.00062], "mK"), "mRhoOld" => uwreal([0.3709,0.0018], "mRhoOld")),
#     "H102" => Dict("mPi" => uwreal([0.15395,0.00071], "mPi"), "mK" => uwreal([0.19144,0.00057], "mK"), "mRhoOld" => uwreal([0.3559,0.0036], "mRhoOld")),
#     "H105" => Dict("mPi" => uwreal([0.12136,0.00124], "mPi"), "mK" => uwreal([0.20230,0.00061], "mK"), "mRhoOld" => uwreal([0.3468,0.0025], "mRhoOld")),
#     "N101" => Dict("mPi" => uwreal([0.12150,0.00055], "mPi"), "mK" => uwreal([0.20158,0.00031], "mK"), "mRhoOld" => uwreal([0.3368,0.0045], "mRhoOld")),
#     "C101" => Dict("mPi" => uwreal([0.09569,0.00073], "mPi"), "mK" => uwreal([0.20579,0.00034], "mK"), "mRhoOld" => uwreal([0.3262,0.0022], "mRhoOld")),
#     "C102" => Dict("mPi" => uwreal([0.09671,0.00078], "mPi"), "mK" => uwreal([0.21761,0.00047], "mK"), "mRhoOld" => uwreal([0.3308,0.0038], "mRhoOld")),   
#     "D150" => Dict("mPi" => uwreal([0.05654,0.00094], "mPi"), "mK" => uwreal([0.20835,0.00035], "mK"), "mRhoOld" => uwreal([0.3198,0.0026], "mRhoOld")),             
#     "B450" => Dict("mPi" => uwreal([0.16063,0.00045], "mPi"), "mK" => uwreal([0.16063,0.00045], "mK"), "mRhoOld" => uwreal([0.3336,0.0013], "mRhoOld")),
#     "S400" => Dict("mPi" => uwreal([0.13506,0.00044], "mPi"), "mK" => uwreal([0.17022,0.00039], "mK"), "mRhoOld" => uwreal([0.3094,0.0021], "mRhoOld")),
#     "N451" => Dict("mPi" => uwreal([0.11072,0.00029], "mPi"), "mK" => uwreal([0.17824,0.00018], "mK"), "mRhoOld" => uwreal([0.3071,0.0019], "mRhoOld")),
#     "N452" => Dict("mPi" => uwreal([0.13546,0.00030], "mPi"), "mK" => uwreal([0.17031,0.00026], "mK"), "mRhoOld" => uwreal([NaN,NaN]      , "mRhoOld")), # from 2203.08676v2
#     "D450" => Dict("mPi" => uwreal([0.08329,0.00043], "mPi"), "mK" => uwreal([0.18384,0.00018], "mK"), "mRhoOld" => uwreal([0.2934,0.0017], "mRhoOld")),
#     "D451" => Dict("mPi" => uwreal([0.08359,0.00030], "mPi"), "mK" => uwreal([0.19402,0.00014], "mK"), "mRhoOld" => uwreal([0.2942,0.0017], "mRhoOld")),  
#     "D452" => Dict("mPi" => uwreal([0.05941,0.00055], "mPi"), "mK" => uwreal([0.18651,0.00015], "mK"), "mRhoOld" => uwreal([0.2855,0.0016], "mRhoOld")),        
#     "H200" => Dict("mPi" => uwreal([0.13535,0.00060], "mPi"), "mK" => uwreal([0.13535,0.00060], "mK"), "mRhoOld" => uwreal([0.2878,0.0019], "mRhoOld")),
#     "N202" => Dict("mPi" => uwreal([0.13424,0.00031], "mPi"), "mK" => uwreal([0.13424,0.00031], "mK"), "mRhoOld" => uwreal([0.2808,0.0015], "mRhoOld")),
#     "N203" => Dict("mPi" => uwreal([0.11254,0.00024], "mPi"), "mK" => uwreal([0.14402,0.00020], "mK"), "mRhoOld" => uwreal([0.2684,0.0014], "mRhoOld")),
#     "N200" => Dict("mPi" => uwreal([0.09234,0.00031], "mPi"), "mK" => uwreal([0.15071,0.00023], "mK"), "mRhoOld" => uwreal([0.2591,0.0023], "mRhoOld")),
#     "D251" => Dict("mPi" => uwreal([0.09293,0.00016], "mPi"), "mK" => uwreal([0.15041,0.00012], "mK"), "mRhoOld" => uwreal([0.2584,0.0015], "mRhoOld")), 
#     "D200" => Dict("mPi" => uwreal([0.06507,0.00028], "mPi"), "mK" => uwreal([0.15630,0.00015], "mK"), "mRhoOld" => uwreal([0.2392,0.0051], "mRhoOld")), 
#     "D201" => Dict("mPi" => uwreal([0.06499,0.00043], "mPi"), "mK" => uwreal([0.16309,0.00024], "mK"), "mRhoOld" => uwreal([0.2477,0.0036], "mRhoOld")), 
#     "E250" => Dict("mPi" => uwreal([0.04170,0.00041], "mPi"), "mK" => uwreal([0.15924,0.00009], "mK"), "mRhoOld" => uwreal([0.2362,0.0019], "mRhoOld")),     
#     "N300" => Dict("mPi" => uwreal([0.10569,0.00023], "mPi"), "mK" => uwreal([0.10569,0.00023], "mK"), "mRhoOld" => uwreal([0.2302,0.0022], "mRhoOld")),
#     "J307" => Dict("mPi" => uwreal([0.10547,0.00042], "mPi"), "mK" => uwreal([0.10547,0.00042], "mK"), "mRhoOld" => uwreal([0.2156,0.0023], "mRhoOld")), # from 2203.08676v2
#     "N302" => Dict("mPi" => uwreal([0.08690,0.00034], "mPi"), "mK" => uwreal([0.11358,0.00028], "mK"), "mRhoOld" => uwreal([0.2172,0.0011], "mRhoOld")),
#     "J306" => Dict("mPi" => uwreal([0.08690,0.00019], "mPi"), "mK" => uwreal([0.11335,0.00019], "mK"), "mRhoOld" => uwreal([0.2107,0.0022], "mRhoOld")), # from 2203.08676v2
#     "J303" => Dict("mPi" => uwreal([0.06475,0.00018], "mPi"), "mK" => uwreal([0.11963,0.00016], "mK"), "mRhoOld" => uwreal([0.2016,0.0015], "mRhoOld")),
#     "J304" => Dict("mPi" => uwreal([0.06550,0.00020], "mPi"), "mK" => uwreal([0.13187,0.00017], "mK"), "mRhoOld" => uwreal([0.2020,0.0015], "mRhoOld")), 
#     "E300" => Dict("mPi" => uwreal([0.04393,0.00016], "mPi"), "mK" => uwreal([0.12372,0.00010], "mK"), "mRhoOld" => uwreal([0.1927,0.0010], "mRhoOld")),
#     "F300" => Dict("mPi" => uwreal([0.03381,0.00023], "mPi"), "mK" => uwreal([0.03381,0.00023], "mK"), "mRhoOld" => uwreal([0.1849,0.0038], "mRhoOld")),   
#     "J500" => Dict("mPi" => uwreal([0.08153,0.00019], "mPi"), "mK" => uwreal([0.08153,0.00019], "mK"), "mRhoOld" => uwreal([0.1701,0.0011], "mRhoOld")), 
#     "J501" => Dict("mPi" => uwreal([0.06582,0.00023], "mPi"), "mK" => uwreal([0.08794,0.00022], "mK"), "mRhoOld" => uwreal([0.1646,0.0011], "mRhoOld"))  
# )
